...
import { PieceColor, PieceType, BoardState, SquareState, Piece } from './types.ts';
...
export const BLACK_RUBBLE_STROKE_COLOR_SVG = "#1F2937"; // Tailwind gray-800 (for black king)
